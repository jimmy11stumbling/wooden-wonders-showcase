        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className={`${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <p className="text-white/90 mb-12 leading-relaxed">
              Since 2010, we've been dedicated to creating exceptional custom cabinetry and furniture that transforms spaces and exceeds expectations. Our journey began with a simple passion for woodworking and has evolved into a commitment to delivering unparalleled craftsmanship to homes across Laredo.
            </p>
